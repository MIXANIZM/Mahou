...
- Exact platform/repository/runtime handoff checks plus wrong-tree, wrong-platform, byte-tamper, schema-v1 legacy, and manifest-inventory inconsistency regression cases.
...
- Artifact verification cross-checks `build-manifest.json.files` against the payload, actual file hashes, and `SHA256SUMS.txt`.

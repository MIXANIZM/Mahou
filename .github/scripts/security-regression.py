...
required = {
    ...
    "smart_caps": ["TryBuildCorrection", "TryDirectReplace", "TryGetStandardEditWordAroundCaret",
                   ...
                   "MaxCandidateAgeMs", "MaxUndoAgeMs", "KMHook.ExcludedProgram()",
                   "WinAPI.GetForegroundWindow() != word.Foreground"],
    "smart_ui": ["Fix two accidental initial capitals", "Исправлять две случайные заглавные",
                 "SmartCapsEnabled", "SmartCapsExceptions", "Clear exceptions", "Очистить исключения"],

...
for marker in (
    ...
    "Manifest files inventory is missing or empty",
    "Manifest hash mismatch with SHA256SUMS.txt",
    "Payload file is missing from manifest files inventory",
    "Manifest files coverage mismatch",
...
for marker in (
    ...
    "manifest files inventory inconsistent with SHA256SUMS.txt",

...
replacements = [
    ...
    (r'Logging.Log("[EXPR] > Expression [" + ex +"] missing its end \"\)\", at positon: " + expr_start +" in: [" + expand + "].", 2);', 'Logging.Log("[EXPR] > Expression is missing its closing parenthesis at position " + expr_start + "; expression length=" + ex.Length + ", snippet length=" + expand.Length + ".", 2);'),

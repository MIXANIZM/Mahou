...
selection_probe = r'''using System;
...
'''
(root / "Mahou" / "Classes" / "SelectionProbe.cs").write_text(selection_probe, encoding="utf-8-sig", newline="\r\n")
...
text = replace_once(text,
'''    <Compile Include="Classes\\RawInputForm.cs" />
    <Compile Include="Classes\\SecretProtector.cs" />
''',
'''    <Compile Include="Classes\\RawInputForm.cs" />
    <Compile Include="Classes\\SelectionProbe.cs" />
    <Compile Include="Classes\\SecretProtector.cs" />
''',
    "SelectionProbe compile item")
write(path, text)

path = "Mahou/Classes/KMHook.cs"
text = read(path)
old = '''\t\tpublic static void ConvertSelectionOrLastWord() {
\t\t\tselectionConversionSucceeded = false;
\t\t\tConvertSelection();
\t\t\tif (!selectionConversionSucceeded) ConvertLast();
\t\t}
'''
new = '''\t\tpublic static void ConvertSelectionOrLastWord() {
...
\t\t}
'''
text = replace_once(text, old, new, "combined Insert action")
write(path, text)

Path(__file__).unlink()
print("Round 5 fast selection probe applied.")

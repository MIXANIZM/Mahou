...
`AGZ-MAH-0014` subsequently recorded
`AUTOSWITCH_FAIL / MODERN_NOTEPAD_DESTRUCTIVE_MUTATION` for exact source
`363a83b227cfa14e798e442960640e7caed03913`. The AutoSwitch and modern
Notepad rows below supersede the broader 2026-07-28 no-op claim. `AGZ-MAH-0015`
adds a containment candidate only; it does not make AutoSwitch verified.
...
| Modern Notepad / `RichEditD2DPT` collapsed-caret Insert and Smart Caps no-op | VERIFIED | Safety checkpoint `d4b37a3dac8b4b35d682c82a9ced7b87eaf9adda`; accepted feasibility merge `d07682a0cdf5ce5ed87ee1ecd5a2ae82b73f2fd1` | `AGZ-MAH-0011` runs: Security `30314045312`, Modern Windows build `30314045291`, Input surface probe `30314045300` | Accepted no-op evidence applies to the direct collapsed-caret/Smart Caps routes, not the legacy AutoSwitch replay path | Keep direct-path no-op; do not broaden this row to AutoSwitch. PR #3 is not an adapter | No | No |
...
| AutoSwitch and bundled dictionary | BLOCKED | Failing source `363a83b227cfa14e798e442960640e7caed03913`; `AGZ-MAH-0015` containment candidate is pending exact-head evidence | Failure artifact: Modern Windows build `30365352449`, x64 artifact `8690549591`, ZIP SHA-256 `4ea545ddbec793f870d69b128cc11758cb61c5d7c388cf2330270aa9f8934a54`; candidate adds x86/x64 executable and source regressions | `AGZ-MAH-0014`: Chrome PASS, Word PASS, modern Notepad FAIL with `ghbdtn` -> `gпривет`, complete deletion on another attempt, and split Undo | Require green exact-head CI, then focused strict-no-op Notepad re-test plus unchanged Chrome/Word routing. Do not claim AutoSwitch verified | Yes | No |
